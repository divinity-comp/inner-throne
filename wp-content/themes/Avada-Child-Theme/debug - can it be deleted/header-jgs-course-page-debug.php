...
<html class="<?php echo ( Avada()->settings->get( 'smooth_scrolling' ) ) ? 'no-overflow-y' : ''; ?>" <?php language_attributes(); ?>>
	...
	<script type="text/javascript">
		...
		jQuery('document').ready(function($j){
			...
			$j('form.acf-form :submit').click(function(event){
				event.preventDefault();

				var form_data = {'action' : 'acf/validate_save_post'};

				$j('form.acf-form :input').each(function(){
...
<body <?php body_class(); ?> post_id="<?php echo $post->ID; ?>" week_id="<?php echo $week_id; ?>" progress_week="<?php echo $progress_week; ?>" progress_step="<?php echo $progress_step; ?>">
