	...
	<?php while ( have_posts() ) : the_post(); ?>
		<article id="post-<?php the_ID(); ?>" <?php post_class( 'post' ); ?>>
			...
			<div class="post-content">
				<?php if(get_field('ryit_subtitle')) {
					echo "<div class='subtitle'><h3>" . get_field('ryit_subtitle') . "</h3></div>";
				} ?>
				<?php if(get_field('ryit_meta_info_box')) {
					echo "<div class='meta-info-box'>" . get_field('ryit_meta_info_box') . "</div>";
				} ?>
				<?php the_content(); ?>
				<?php if(get_field('ryit_meta_content_box')) {
					echo "<div class='meta-content-box'>" . get_field('ryit_meta_content_box') . "</div>";
				} ?>
			...
			<?php if ( ! post_password_required( $post->ID ) ) : ?>
				...
				<?php 
					...
					if(function_exists('social_warfare')):
						...
						echo "<p style='text-align: center; font-weight: bold; margin: 30px 0 0 0;'>If you liked this content, please help us spread it. Thank you!</p>";
					    social_warfare();
					endif;
					//avada_render_social_sharing(); ?>
					<?php echo do_shortcode('[ryit_fb_apps]'); ?>
