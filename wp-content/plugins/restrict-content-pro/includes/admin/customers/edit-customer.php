			...
			<table class="wp-list-table widefat striped payments">
				...
				<?php if ( ! empty( $payments ) ) : ?>
					...
					<?php if ( $number_payments > 5 ) : ?>
						<tr>
							<td colspan="6">
								<a href="<?php echo esc_url( add_query_arg( 'customer_id', urlencode( $customer->get_id() ), admin_url( 'admin.php?page=rcp-payments' ) ) ); ?>"><?php printf( __( 'View all %d payments', 'rcp' ), number_format_i18n( $number_payments ) ); ?></a>
							</td>
						</tr>
					<?php endif; ?>
				<?php else : ?>
