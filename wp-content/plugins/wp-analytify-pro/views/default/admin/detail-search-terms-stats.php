...
function pa_include_detail_search_terms () {
  ...
  $search_terms_stats = '';
  // $search_terms_stats = $GLOBALS['WP_ANALYTIFY']->pa_get_analytics_dashboard( 'ga:sessions', $start_date, $end_date,'ga:userAgeBracket,ga:userGender', false, false, 20, 'show-demographic-stats' );
  ...
  <div class="analytify_wraper">
    <div class="analytify_main_title_section">
      ...
      <h1 class="analytify_pull_left analytify_main_title"><a href="<?php echo admin_url('admin.php?page=analytify-dashboard');?>"><?php esc_html_e( 'Dashboard', 'wp-analytify-pro' ); ?></a>
        ...
        <span class="analytify_stats_of"><?php esc_html_e( 'Search Terms Statistics of the Site', 'wp-analytify-pro' ); ?> <a href="<?php echo WP_ANALYTIFY_FUNCTIONS::search_profile_info( $dashboard_profile_ID, 'websiteUrl' ) ?>" target="_blank"><?php echo WP_ANALYTIFY_FUNCTIONS::search_profile_info( $dashboard_profile_ID, 'websiteUrl' ) ?></a></span></h1>
                    ...
                    if ( isset( $search_terms_stats['rows'] ) && $search_terms_stats['rows'] > 0 ) {
                      ...
                      foreach ( $search_terms_stats['rows'] as $search_term ) :
                        ...
                        <tr>
                          ...
                          <td><?php echo "Test" ?></td>
                          <td class="analytify_txt_center"><?php echo "100" ?></td>
                        </tr>
                        <?php
                        $i++;
                      endforeach;
