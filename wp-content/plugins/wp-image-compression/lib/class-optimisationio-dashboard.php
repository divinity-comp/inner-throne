...
class Optimisationio_Dashboard {
						...
						if( isset( $decoded_data[$slug] ) ){
							switch( $slug ){
								...
								case self::$addons_slug[2]:	// 'wp-image-compression'.
									...
									// if( isset( $decoded_data[$slug]['use_our_image_cdn'] ) ){
									// 	update_option( 'wpimages_use_our_image_cdn', $decoded_data[$slug]['use_our_image_cdn'] );
									// }
	...
	public static function track_load_time_settings(){
		?>
		<div class="sidebar-publitio-api sidebar-track-load-time">
